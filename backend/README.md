...
## Project Structure
    ...
    ├── sushi_delivery_app_37853  # Django project configurations
...
1. Clone this repo and `cd sushi_delivery_app_37853`
...
2. Clone this repo and `cd sushi_delivery_app_37853`
